...
| Rotate API keys before switching a gateway route | [OpenAI-Compatible API Key Rotation Kit](https://github.com/vivian254338489/openai-compatible-api-key-rotation-kit) | https://www.tken.shop/?utm_source=github&utm_medium=awesome_readme&utm_campaign=customer_acquisition&utm_content=decision_api_key_rotation |
...
| Attribute LLM cost by user, feature, route, model, retry, and tool call | [LLM Cost Attribution Recipes](https://github.com/vivian254338489/llm-cost-attribution-recipes) | https://www.tken.shop/?utm_source=github&utm_medium=awesome_readme&utm_campaign=customer_acquisition&utm_content=decision_cost_attribution |
...
| `llm cost attribution` | [LLM Cost Attribution Recipes](https://github.com/vivian254338489/llm-cost-attribution-recipes) | Maps gateway spend by team, user, feature, route, model, retry, cache miss, and tool call. | https://www.tken.shop/?utm_source=github&utm_medium=awesome_readme&utm_campaign=customer_acquisition&utm_content=search_cost_attribution |
...
| Check OpenAPI specs before exposing them as MCP tools | [OpenAPI MCP Contract Check Kit](https://github.com/vivian254338489/openapi-mcp-contract-check-kit) |
...
| Check API key rotation and env hygiene before cutover | [OpenAI-Compatible API Key Rotation Kit](https://github.com/vivian254338489/openai-compatible-api-key-rotation-kit) |
...
| Attribute LLM spend by user, team, feature, route, model, retry, and tool call | [LLM Cost Attribution Recipes](https://github.com/vivian254338489/llm-cost-attribution-recipes) |
...
| --- | --- |
| Validate a new `base_url` | Provider switch checklist -> provider migration CI kit -> API key rotation kit -> prompt regression CI kit -> API conformance kit -> endpoint tester -> SDK smoke tests -> JSON mode validator -> streaming/tool-call checks |
...
- [OpenAI-Compatible API Key Rotation Kit](https://github.com/vivian254338489/openai-compatible-api-key-rotation-kit) - offline API key rotation, env hygiene, smoke-test, rollback, and revoke readiness checks.
...
- [OpenAPI MCP Contract Check Kit](https://github.com/vivian254338489/openapi-mcp-contract-check-kit) - offline static checks for OpenAPI operations before exposing selected endpoints as agent tools.
...
- [LLM Cost Attribution Recipes](https://github.com/vivian254338489/llm-cost-attribution-recipes) - offline cost attribution by user, workspace, team, feature, route, model, retry, cache miss, and tool call.
