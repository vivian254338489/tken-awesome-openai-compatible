...
for (const text of [
  ...
  "openai-compatible-provider-switch-checklist",
  ...
  "mcp-tool-schema-budget-kit",
  "openai-compatible-tool-call-replay-lab",
  "agent-memory-portability-kit",
  "https://vivian254338489.github.io/openai-compatible-agent-tooling-landing/",
  "Decision Shortcuts",
  "decision_switch_endpoint",
  "decision_provider_switch",
  "decision_provider_migration_ci",
  "decision_api_key_rotation",
  "decision_prompt_regression_ci",
  "decision_billing_reconciliation",
  "decision_cost_guardrail",
  "decision_gateway_eval",
  "decision_usage_observability",
  "decision_mcp_tools",
  "decision_log_redaction",
  "GitHub Search Intent Map",
  "search_endpoint_tester",
  "search_sdk_smoke_tests",
  "search_fallback_proxy",
  "search_mcp_server",
  "search_webui_gateway",
  "search_cost_calculator",
  "search_json_validator",
  "search_continue_config",
  "Route Map",
